...
Adaptive parallel tempering algorithms automaticly tune the temperatures of the temperature ladder
...
Finally, note that WAIC can be computed in exactly the same way as in nimble. See the section 'calculating WAIC' in the nimble manual for further etails.
